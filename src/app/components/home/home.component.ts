...
export class HomeComponent implements OnInit {
  ...
  colorValuePath: 'infection',
     ...
     minRadius: 5,
     dataSource: [
      {name: "Manouba", infection:   136  },
      {name: "Beja",infection:       49   },
      {name: "Ben Arous",infection:  954  },
      {name: "Gabes", infection:     1060 },
      {name: "Gafsa",infection:      83   },
      {name: "Jendouba", infection:  129  },
      {name: "Kairouan", infection:  221  },
      {name: "Kasserine",infection:  77   },
      {name: "Kebili", infection:    228  },
      {name: "Le Kef", infection:    360  },
      {name: "Medenine", infection:  289  },
      {name: "Mahdia", infection:    101  },
      {name: "Tataouine",infection:  144  },
      {name: "Tozeur", infection:    15   },
      {name: "Zaghouan", infection:  16   },
      {name: "Monastir", infection:  517  },
      {name: "Sidi Bouzid",infection:85   },
      {name: "Siliana", infection:   60   },
      {name: "Sousse", infection:    679  },
      {name: "Ariana", infection:    422  },
      {name: "Bizerte", infection:   132   },
      {name: "Nabeul", infection:    265  },
      {name: "Tunis", infection:     1030  },
      {name: "Sfax",infection:       320  }
